<template>
  <section class="searchfiltertable">
    ...
    aria-label="..."
     />
                  ...
                  <th scope="col" class="px-6 py-4">Sales Rep</th>
                  <th scope="col" class="px-6 py-4">Approved</th>
                  <th scope="col" class="px-6 py-4">Loan</th>
                  <th scope="col" class="px-6 py-4">Ussd</th>
              ...
              <tbody>
                <tr
                  ...
                  <td class="whitespace-nowrap px-6 py-4 font-medium">John Kariuki</td>
                  <td class="whitespace-nowrap px-6 py-4">0724534789</td>
                  <td class="whitespace-nowrap px-6 py-4">HQ</td>
                  <td class="whitespace-nowrap px-6 py-4">Marcus Oriela</td>
                  <td class="whitespace-nowrap px-6 py-4 font-medium">500</td>
                  <td class="whitespace-nowrap px-6 py-4">140,000</td>
                  ...
                  <td class="whitespace-nowrap px-6 py-4"><!-- Required font awesome -->
                    <button
                      type="button"
                      data-te-ripple-init
                      ...
                      <PencilIcon class="h-6 w-6 text-white-500 px-1" />
                      Button
                    </button></td>
                </tr>
                <tr
          ...
          <td class="whitespace-nowrap px-6 py-4 font-medium">JJJJJ Polukish</td>
          <td class="whitespace-nowrap px-6 py-4">0724534789</td>
          <td class="whitespace-nowrap px-6 py-4">HQ</td>
          <td class="whitespace-nowrap px-6 py-4">Marcus Oriela</td>
          <td class="whitespace-nowrap px-6 py-4 font-medium">500</td>
